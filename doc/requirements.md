...
| ST-CHT-06 | 版を改訂するときは、共通の観測点を使って Procrustes 法で座標系を整列し、軸の反転や回転を補正すること。回転・符号・尺度の固定は statistics.md §5 に従うこと | MUST |
...
| ST-POS-03 | 現在地と一緒に、事後標準偏差と95%信用領域を算出すること。事後が多峰のときは楕円ではなく HPD 領域を用いること（statistics.md §6.3） | MUST |
