...
-- Dummy item bank (item_set_version 0.2): 30 anchors, 10 blocks x 20, 2 quality items.
...
select i, format('A%s', lpad(i::text, 2, '0')), '0.2', 'personality',
...
select 100 + b * 20 + j, format('B%s-%s', b, lpad(j::text, 2, '0')), '0.2', 'personality',
...
insert into app.questions (id, code, item_set_version, kind, status, quality_rule, text_ja) values
  (900, 'QA1', '0.2', 'quality', 'candidate', '{"type":"attention","expect":4}',
   'この項目では「4」を選んでください。'),
  (901, 'QR1', '0.2', 'quality', 'candidate', '{"type":"repeat","of":"A01"}',
